...
_DESCRIPTION = """\
PANDA_MIL dataset, released as part of the torchmil library (https://torchmil.github.io/).
"""
...
class PANDA_MIL(datasets.GeneratorBasedBuilder):
    """
    PANDA_MIL dataset, adapted for MIL from the Prostate cANcer graDe Assessment (PANDA) Challenge (https://www.kaggle.com/c/prostate-cancer-grade-assessment/data). 
